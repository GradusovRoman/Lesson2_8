package geekbrains.lesson2_8gb.impl;
import geekbrains.lesson2_8gb.GBIterator;
import geekbrains.lesson2_8gb.GBList;
...
public class DoublyLinkedList implements GBList {
    ...
    public String toString() {
        Node current = first;
        StringBuilder sb = new StringBuilder("Двусвязный список:\n");
    ...
    // 2. Реализовать метод GBList#get(int index): String. Метод получает на вход значение N >= 0,
